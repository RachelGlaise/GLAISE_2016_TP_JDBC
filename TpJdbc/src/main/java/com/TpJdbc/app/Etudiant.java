...
public class Etudiant implements Serializable {
	...
	private int annee;
	private int groupe;
	private Set<Module> notations = new HashSet<>();
	private Set<Enseignement> enseignement = new HashSet<>();

	//private HashMap<Module, Notation> notations;
	...
	//GETTERS-SETTERS
	public Set<Module> getNotations() {
		return notations;
	}

	public void setNotations(Set<Module> notations) {
